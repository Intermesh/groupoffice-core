...
import {CustomFieldOptionDialog} from "./CustomFieldOptionDialog.js";
import {fieldDS} from "../index.js";

export class CustomFieldSelectOptionsTree extends Component {
					...
					rowcontextmenu: ({target, storeIndex, ev}) => {
						...
						const contextMenu = menu({
							...
							btn({
								...
								text: t("Edit"),
								handler: () => {
									const dlg = new CustomFieldOptionDialog();
